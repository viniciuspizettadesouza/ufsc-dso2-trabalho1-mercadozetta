...
| ----------------------- | ------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- |
| `tenants`               | Platform tenant configuration                                       | `created_at`; no expiry or inactive state                                                                                                           | No delete operation                                                                                                                                                                                                          | Parent integrity anchor for tenant-scoped records; dependent foreign keys use `ON DELETE RESTRICT`                                                                                                         | Retained domain state/history |
...
| `products`              | Seller catalog and inventory                                        | `created_at`, `updated_at`, `status`, and inventory; `archived` represents retirement                                                               | No hard-delete operation. Sellers change lifecycle state, and account deactivation archives owned listings                                                                                                                   | Seller and tenant references use `ON DELETE RESTRICT`; cart items, watchlists, order items, and reviews also restrict product deletion                                                                     | Retained domain state/history |
...
| `orders`                | Buyer commerce history                                              | `created_at`, `updated_at`, and lifecycle `status`; no expiry field                                                                                 | No delete operation                                                                                                                                                                                                          | Buyer and tenant deletion are restricted; order items and status history restrict order deletion                                                                                                           | Retained domain state/history |
| `order_items`           | Order history, with buyer-visible product snapshot and seller scope | `created_at` and `updated_at`; no expiry field                                                                                                      | No update or delete repository operation                                                                                                                                                                                     | Order, product, and seller references use tenant-qualified `ON DELETE RESTRICT` keys                                                                                                                       | Retained domain state/history |
...
status history, reviews, or audit events. Product retirement and user removal
